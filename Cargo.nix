  ...
  internal = rec {
    ...
    crates = {
      ...
      "ariadne" = rec {
        ...
        version = "0.4.1";
        edition = "2018";
        sha256 = "1qpqh7x7ybfmgjp1vmnjs1z2g8fbwkvbkch3p5yfyjk7gicmw1a4";
        authors = [
      ...
      "bevy_app" = rec {
        ...
        resolvedDefaultFeatures = [ "bevy_debug_stepping" "bevy_reflect" "default" "trace" ];
      };
      "bevy_asset" = rec {
      ...
      "bevy_async_util" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "10257db357004aa3a772aecf5cf948aeb5045488";
          sha256 = "1rr18779f04j1hxw3gqykdggfhdm4hqqvdln268lk7nm8w8qxmdh";
        };
        dependencies = [
          {
            name = "bevy";
      ...
      "bevy_dylib" = rec {
        ...
        version = "0.13.2";
        edition = "2021";
        sha256 = "1k306s83716znr6sm3xbhz70q9k2lvn8rqa9df1ijz7kp3ijca4j";type = [ "dylib" ];
        dependencies = [
          {
            name = "bevy_internal";
            packageId = "bevy_internal";
      ...
      "bevy_ecs" = rec {
        ...
        resolvedDefaultFeatures = [ "bevy_debug_stepping" "bevy_reflect" "default" "multi-threaded" "trace" ];
      };
      "bevy_ecs_macros" = rec {
      ...
      "bevy_hierarchy" = rec {
        ...
        resolvedDefaultFeatures = [ "bevy_app" "bevy_core" "bevy_log" "bevy_reflect" "default" "reflect" "trace" ];
      };
      "bevy_input" = rec {
      ...
      "bevy_mud" = rec {
        ...
        resolvedDefaultFeatures = [ "bevy_dylib" "default" "tracing-tracy" "tracy" "tracy-client" "tracy_memory" ];
      };
      "bevy_ptr" = rec {
        crateName = "bevy_ptr";
        version = "0.13.2";
      ...
      "bevy_render" = rec {
        ...
        resolvedDefaultFeatures = [ "multi-threaded" "profiling" "trace" ];
      };
      ...
      "bevy_sqlite" = rec {
        ...
        workspace_member = null;
        src = pkgs.fetchgit {
          url = "git+ssh://git@github.com/jrobsonchase/bevy_sqlite";
          rev = "584865f85168e2be728f5b464c410513d1ed2333";
          sha256 = "1r6030rqjkbcc26zv4m1ifcl0i4q3hdnqa7d6yn6siip4h3kzmaf";
        };
        dependencies = [
          {
            name = "bevy";
      ...
      "chumsky" = rec {
        ...
        edition = "2021";
        sha256 = "07qgyayw2vyrgfzfp4b0qsiwvadvacnm99kcqnfpi1kgk1v05f67";
        authors = [
          "Joshua Barretto <joshua.s.barretto@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "default" "spill-stack" "std" ];
      };
      "cipher" = rec {
        crateName = "cipher";
        version = "0.4.4";
      ...
      "ngrok" = rec {
        ...
        edition = "2021";
        sha256 = "1gwlp111whdp8dlb2asfisv9c4j0zpcdlc1fpwknhv5k8nhshymb";
        dependencies = [
          {
            name = "arc-swap";
            packageId = "arc-swap";
      ...
      "rustls 0.22.4" = rec {
        ...
        dependencies = [
          ...
          {
            name = "rustls-webpki";
            packageId = "rustls-webpki 0.102.3";
            rename = "webpki";
            usesDefaultFeatures = false;
            features = [ "std" ];
          }
      ...
      "tracing-tracy" = rec {
        ...
        version = "0.10.5";
        edition = "2021";
        sha256 = "12r4c4azwqx759r9i1mqyrmhgzh07134zg8kfkyirb6k083dz87w";
      ...
      "tracy-client" = rec {
        ...
        version = "0.16.5";
        edition = "2021";
        sha256 = "11r99m26nknihnagamf3fnx4jmbr8259i1yx1xjfjbqi61q6nzih";
      ...
      "wgpu" = rec {
        ...
        resolvedDefaultFeatures = [ "dx12" "fragile-send-sync-non-atomic-wasm" "hal" "metal" "naga" "naga-ir" "wgc" "wgsl" ];
      };
      "wgpu-core" = rec {
        crateName = "wgpu-core";
        version = "0.19.4";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "combaseapi" "consoleapi" "d3d12" "d3d12sdklayers" "d3d12shader" "d3dcommon" "d3dcompiler" "dcomp" "dxgi1_2" "dxgi1_3" "dxgi1_4" "dxgi1_5" "dxgi1_6" "dxgidebug" "dxgiformat" "errhandlingapi" "evntrace" "fibersapi" "fileapi" "handleapi" "impl-debug" "impl-default" "in6addr" "inaddr" "libloaderapi" "memoryapi" "minwinbase" "minwindef" "ntsecapi" "oleauto" "processenv" "processthreadsapi" "profileapi" "std" "synchapi" "sysinfoapi" "winbase" "windef" "winerror" "winioctl" "winuser" "wtypes" "wtypesbase" ];
      };
      ...
      "windows-sys 0.45.0" = rec {
        ...
        resolvedDefaultFeatures = [ "Win32" "Win32_Foundation" "Win32_Globalization" "default" ];
      };
